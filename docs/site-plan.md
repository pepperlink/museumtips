...
> Phase 2 (calendar UX + polish) implementation is specified in [PLAN.md](PLAN.md) at the repo root. Phase 3b (museum & exhibition pages) is in [PLAN.md §3b](PLAN.md#plan--phase-3b-museum--exhibition-pages-plan).
